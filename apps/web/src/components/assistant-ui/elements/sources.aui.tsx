...
const SourcesImpl: SourceMessagePartComponent = (part) => {
  if (part.sourceType === "url" && part.url) {
    ...
    return (
      <Source href={part.url} className="my-1 me-1">
  ...
  if (part.sourceType === "document") {
    return (
      <span
        data-slot="source"
        className="bg-secondary text-secondary-foreground my-1 me-1 inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium"
      >
        <DocumentSourceIcon />
